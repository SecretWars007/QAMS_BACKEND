...
{
    /// <inheritdoc />
    public partial class AddTestCaseVersioning : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_test_plans_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "projects",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_test_plans_users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_test_plans_users_DeletedByUserId",
                        column: x => x.DeletedByUserId,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_test_plans_users_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_test_plan_suites", x => new { x.TestPlanId, x.TestSuiteId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_test_plan_suites_users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_test_plan_suites_users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_test_plan_suites_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_test_plan_suites_UpdatedByUserId",
                table: "test_plan_suites",
                column: "UpdatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_test_plans_CreatedByUserId",
                table: "test_plans",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_test_plans_DeletedByUserId",
                table: "test_plans",
                column: "DeletedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_test_plans_ProjectId",
                table: "test_plans",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_test_plans_UpdatedByUserId",
                table: "test_plans",
                column: "UpdatedByUserId");
        }
