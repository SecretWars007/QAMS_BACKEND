        ...
        ILogger<CatalogService> logger) : ICatalogService
    {
        ...
        private async Task<TResult> ResolveRepo<TResult>(string catalogName, Func<dynamic, Task<TResult>> action)
        {
            var type = catalogName.ToLower() switch
            {
                ...
                "requirementstatus" => typeof(RequirementStatus),
                "requirementcomplexity" => typeof(RequirementComplexity),
                "requirementtype" => typeof(RequirementType),
                "requirementpriority" => typeof(RequirementPriority),
                "teststrategy" => typeof(TestStrategy),
                "risklevel" => typeof(RiskLevel),
                "testenvironment" => typeof(TestPlanEnvironment),
                "testlevel" => typeof(TestLevel),
                "suiteautomationstatus" => typeof(SuiteAutomationStatus),
                "tag" => typeof(Tag),
                "defectpriority" => typeof(DefectPriority),
                "defectstatus" => typeof(DefectStatus),
                "findingseverity" => typeof(FindingSeverity),
                "findingstatus" => typeof(FindingStatus),
                "findingtype" => typeof(FindingType),
                "projectpriority" => typeof(ProjectPriority),
                "reviewstatus" => typeof(ReviewStatus),
                "reviewtype" => typeof(ReviewType),
                "testdesigntechnique" => typeof(TestDesignTechnique),
                "testplanstatus" => typeof(TestPlanStatus),
                "testplantype" => typeof(TestPlanType),
        ...
        private static CatalogBase CreateEntityInstance(string catalogName)
        {
            return catalogName.ToLower() switch
            {
                ...
                "requirementcomplexity" => new RequirementComplexity(),
                "requirementtype" => new RequirementType(),
                "requirementpriority" => new RequirementPriority(),
                "testlevel" => new TestLevel(),
                "suiteautomationstatus" => new SuiteAutomationStatus(),
                "tag" => new Tag(),
                "defectpriority" => new DefectPriority(),
                "defectstatus" => new DefectStatus(),
                "findingseverity" => new FindingSeverity(),
                "findingstatus" => new FindingStatus(),
                "findingtype" => new FindingType(),
                "projectpriority" => new ProjectPriority(),
                "reviewstatus" => new ReviewStatus(),
                "reviewtype" => new ReviewType(),
                "testdesigntechnique" => new TestDesignTechnique(),
                "testplanstatus" => new TestPlanStatus(),
                "testplantype" => new TestPlanType(),
